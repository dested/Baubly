...
System.register("server/staticServer", ["server/serverMain"], function(exports_3, context_3) {
    "use strict";
    var __moduleName = context_3 && context_3.id;
    var serverMain_1;
    var express, cors, StaticServer;
    return {
        setters:[
            function (serverMain_1_1) {
                serverMain_1 = serverMain_1_1;
            }],
        execute: function() {
            debugger;
            ...
            StaticServer = (function () {
                function StaticServer() {
                    ...
                    app.get('/game-state', function (req, res) {
                        var m = new Compressor().CompressText(JSON.stringify(serverMain_1.ServerMain.board));
            ...
            exports_3("StaticServer", StaticServer);
        }
    }
});
System.register("server/serverMain", ["server/gameBoard", "server/staticServer"], function(exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    var GameBoard_1, staticServer_1;
    var ServerMain;
    return {
        setters:[
            ...
            function (staticServer_1_1) {
                staticServer_1 = staticServer_1_1;
            }],
        execute: function() {
            ServerMain = (function () {
                function ServerMain() {
                }
                ServerMain.run = function () {
                    this.initialize();
                    this.startStaticServer();
                };
                ServerMain.initialize = function () {
                    this.board = GameBoard_1.GameBoard.generateBoard();
                };
                ServerMain.startStaticServer = function () {
                    new staticServer_1.StaticServer();
                };
                return ServerMain;
            }());
            exports_4("ServerMain", ServerMain);
            ServerMain.run();
        }
    }
});
